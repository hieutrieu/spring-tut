...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <div class="btn-group-sm">
                <a href="{{url('admin/users/admin/edit/0')}}" class="btn btn-lg btn-primary "><i
    ...
    <div class="box-body no-padding">
        <div class="mailbox-controls clearfix">
            <div class="row">
                <div class="col-md-6">
                    <form role="form" class="form-inline" method="GET" action="{{url('admin/users/admin')}}">
        ...
        <div class="table-responsive mailbox-messages">
            <table class="table table-striped table-bordered table-hover" align="center">
                ...
                <tr>
                    ...
                    <td class="text-left">
                        <a href="{{url('admin/users/admin/edit/'.$value['id'])}}" class="{{$value['id']}}">
                            {{$value['name']}}
                        </a>
                    </td>
                    ...
                    <td class="text-center middle">
                        <div class="btn-group-xs">
                            <a href="{{url('admin/users/admin/edit/'.$value['id'])}}"
                               class="btn btn-small btn-sm btn-warning ">Edit | <span class="fa fa-edit"></span></a>
                            <a href="{{url('admin/users/admin/delete/'.$value['id'])}}"

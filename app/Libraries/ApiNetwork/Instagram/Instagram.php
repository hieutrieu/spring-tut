...
namespace App\Libraries\ApiNetwork\Instagram;
...
class Instagram
{
    ...
    public function __construct($config)
    {
        if (is_array($config)) {
            ...
            $this->setApiCallback(url($config['apiCallback']));
     ...
     * @throws \MetzWeb\Instagram\InstagramException
     */
    public function getLoginUrl($scopes = array('basic','likes','relationships'))
    {
